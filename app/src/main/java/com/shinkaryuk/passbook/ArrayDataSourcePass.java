...
//    @NonNull
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view){
            super(view);
            imageFav = view.findViewById(R.id.colFavImg);
            imageCrypt = view.findViewById(R.id.colIsCryptoImg);
            nameView = view.findViewById(R.id.colNameText);
            dateCreate = view.findViewById(R.id.tvDateCreatePass);
            divider = view.findViewById(R.id.dividerPass);

            etName = view.findViewById(R.id.etNamePass2);
            etLogin = view.findViewById(R.id.etLoginPass2);
            etPass = view.findViewById(R.id.etPassPass2);
            etComment = view.findViewById(R.id.etCommentPass2);
            showPass = view.findViewById(R.id.cb_ShowPasswd2);
            btOk = view.findViewById(R.id.buttonPassOk);
            btCancel = view.findViewById(R.id.buttonPassCancel);
            tvCreate1 = view.findViewById(R.id.tvCreatePass1);
            tvCreate2 = view.findViewById(R.id.tvCreatePass2);
            tvChange1 = view.findViewById(R.id.tvChangePass1);
            tvChange2 = view.findViewById(R.id.tvChangePass2);
            ibKeyGenerate = view.findViewById(R.id.ibKeyGenerate);
            ivIsOpenEditor = view.findViewById(R.id.ivIsOpenEditor);
            tvNamePass = view.findViewById(R.id.tvNamePass);
            tvLoginPass = view.findViewById(R.id.tvLoginPass);
            tvPasswordPass = view.findViewById(R.id.tvPasswordPass);
            tvCommentPass = view.findViewById(R.id.tvCommentPass);
            btEditInWindow = view.findViewById(R.id.btEditInWindow);
            divider2 = view.findViewById(R.id.divider2);
            divider3 = view.findViewById(R.id.divider3);
            ivExpandItem = view.findViewById(R.id.ivExpandItem);
            clPass = view.findViewById(R.id.clPass);
