...
public class swipeListView {
    ...
    public void exec() {
        ...
        REL_SWIPE_MIN_DISTANCE = (int) (50.0f * dm.densityDpi / 160.0f + 0.5);//в исходном варианте было (120.0f * dm.densityDpi / 160.0f + 0.5)
        REL_SWIPE_MAX_OFF_PATH = (int) (380.0f * dm.densityDpi / 160.0f + 0.5);//в исходном варианте было (250.0f * dm.densityDpi / 160.0f + 0.5);
        REL_SWIPE_THRESHOLD_VELOCITY = (int) (10.0f * dm.densityDpi / 160.0f + 0.5);//в исходном варианте было (200.0f * dm.densityDpi / 160.0f + 0.5)
        //
